...
import net.skhu.example.firebase.FirebaseDbService
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var firebaseDbService: FirebaseDbService<Item>
    private var itemEditDialogFragment: ItemEditDialogFragment? = null
